...
return array_replace_recursive($arabic, [
    ...
    'fields' => [
        ...
        'reserved_or_used_capacity' => 'Reserved / used capacity',
        'usable_remaining_capacity' => 'Remaining usable capacity',
        'actual_shortage' => 'Actual shortage',
        'surplus_capacity' => 'Surplus if any',
    ],
    'helpers' => [
    ...
    'global_hall_distribution' => [
        ...
        'failure_details_hint' => 'Shows the affected subject, nominal, used, remaining usable capacity, failure reason, and suggested action.',
        ...
        'failure_reasons' => [
            ...
            'insufficient_capacity' => 'Students: :students, remaining usable suitable capacity: :capacity. Actual shortage: :shortage seats.',
            ...
            'hall_type_capacity_shortage' => 'This subject requires a drawing studio / lab. Students: :students, remaining usable drawing studio / lab capacity: :capacity. Actual shortage: :shortage seats.',
            ...
            'pinned_exam_no_capacity' => 'This subject is pinned to a slot without enough remaining usable capacity. Students: :students, remaining usable capacity: :capacity, actual shortage: :shortage seats.',
