...
<body>
        ...
        <table class="header-table">
            <tr>
                ...
                <td>
                    ...
                    <div class="muted">{{ __('exam.fields.report_type') }}: {{ __('exam.sections.invigilator_shortage') }}</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="8">{{ __('exam.diagnosis.invigilators_all_distributed') }}</td></tr>
            @endforelse
        </tbody>
    </table>
</body>
